...
# Variables
image_name="helpdroidadmin-helpdroid-admin-react-app"
image_tag="latest"
docker_username="vikashraj1825" # Replace this with your Docker Hub username
repository_name="helpdroidadmin-helpdroid-admin-react-app" # This can be customized to your preferred repository name on Docker Hub
